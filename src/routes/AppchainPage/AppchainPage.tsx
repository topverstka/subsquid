        ...
        <>
            ...
            <Content>
                <div className="Container">
                    <PageBanner title='Empower builders on your network' subtitle='Appchain, L1 or L2:' text='Save >90% on RPC costs and make it completely free to developers to access data on your network.' buttons={[
                        {
                            ...
                            list: [
                                {
                                    ...
                                    list: [<span>Up to <b>$2k/m per node</b></span>, <span>Multiple nodes needed for in-demand chains</span>]
                                },
                                {
                                    title: "DevOps",
                    ...
                    <Card className="AppchainPromo" type={CardType.secondary}>
                        <img src={GlobeImg} alt=""/>
                        <p>100+ blockchains made free-to-access for developers & analysts</p>
                    </Card>
                </div>
            </Content>
            <Footer/>
