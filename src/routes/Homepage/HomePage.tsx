                        ...
                        <Card className="HomePage__section animation-scale-hover" type={CardType.primary}>
                            <div className="HomePage-card">
                                ...
                                <div className="HomePage-card__buttons">
                                    <Link to="/builders" className='HomePage-card__button1 Button Button--secondary'>Learn
                                        more</Link>
                                    <a target="_blank" href="https://docs.subsquid.io/"
                                       className='HomePage-card__button2 Button'>Docs</a>
                                </div>
                            </div>
                        </Card>
                    </FadeInSection>
                        ...
                        <Card className="HomePage__section animation-scale-hover" type={CardType.primary}>
                            <div className="HomePage-card">
                                ...
                                <p className="HomePage-card__desc">All network data ingested & stored for rapid and free
                                    access by devs.</p>
                                <div className="HomePage-card__buttons">
                                    <Link to="/appchain" className='HomePage-card__button1 Button Button--secondary'>Learn
                                        more</Link>
                                    <a target="_blank"
                                       href="https://app.deform.cc/form/3f1021b2-6b70-4850-af09-a3b610f048a4/"
                                       className='HomePage-card__button2 Button'>Onboard</a>
                                </div>
                            </div>
                        </Card>
                    </FadeInSection>
                        ...
                        <Card className="HomePage__section" type={CardType.primary}>
                            <div className="HomePageCard">
                                ...
                                <p className="HomePageCard__text">Subsquid is a decentralized data lake network and
                                    open-source indexing SDK that exists to make Web3 data free & easy for anybody to
                                    access
                            ...
                            <Card type={CardType.primary}>
                                <div className="HomePageCard">
                                    ...
                                    <p className="HomePageCard__text">For product and network support please join <a
                                        href="https://discord.com/invite/subsquid" target="_blank">our Discord</a> and
                                        ask
                                        questions in the #Dev-Chat and #Testnet channels.
                                    </p>
