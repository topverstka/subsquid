...
export default function GitHub(props: GitHubProps) {
    ...
    useEffect(() => {
        fetch(`https://api.github.com/repos/${props.username}/${props.reponame}`).then(res => {
            res.json().then((data) => {
    ...
    return (
        <a href={`https://github.com/${props.username}/${props.reponame}`} className="github" target="_blank">
            <div className="github__section">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <g clipPath="url(#clip0_57_9275)">
